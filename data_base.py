...
retrieval_k = st.sidebar.number_input("Retriever k", min_value=1, max_value=10, value=4)
...
def load_and_index(chunk_size, chunk_overlap, retriever_k):
    ...
    docs = loader.load()
    docs = docs  # Limit for performance
...
for q, a in st.session_state.history:
    ...
    st.latex(q)   # show user's math query nicely rendered
